...
def main(args):
    ...
    if args.mode == 'play':
        ...
        train3d(os.path.join(DIR_PATH, 'logs', 'tensorboard', args.env, EXPERIMENT_ID))
    elif args.mode=='play3d':
        play3d()
            ...
            if (model == PPO):
                if args.recurrent:
                    ...
                    hyperparams = {
                        ...
                        'batch_size': 32,      # Default 4, prev 32
        ...
        record_agent_freq = total_timesteps // 10  # Evaluate, record, and save agent 10 times during training (EvalCallback)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        choices=['play','play3d', 'train','train3d', 'enjoy', 'test', 'policyplot', 'vectorfieldplot', 'streamlinesplot'],
    )
    parser.add_argument(
        'env',
